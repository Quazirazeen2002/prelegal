...
export default function NdaDownloadButton({
  ...
  return (
    <PDFDownloadLink
      ...
      fileName={fileName}
      className="inline-flex items-center justify-center rounded-full bg-brand-purple px-4 py-2 text-sm font-bold text-on-brand shadow-sm transition-colors hover:bg-brand-purple-dark"
    >
